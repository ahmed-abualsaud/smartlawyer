...
@section('content')
    ...
    <div class="content-wrapper" style="background-color: transparent">
        <div style="font-family: 'Cortoba', Sans-Serif; color: gold; margin-top: 1vh; margin-bottom: 2vh;margin-right: 3vw;
...
@section('scripts')
    <script type="text/javascript">
        ...
        var dataTable = $('#data').DataTable({
            ...
            select: true,
            ajax: {
                "url": '{{route("offices.fetchOffices")}}',
                "type": 'GET'
            },
            columns: [
                {data: 'name', name: 'name'},
        ...
        function changeStatus(id,status) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        'url':'{{route('offices.changeStatus')}}',
                        'type':'POST',
                        'data':{
                            'id' : id,
                            'status' : status,
