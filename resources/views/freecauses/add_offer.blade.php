            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="box">
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form action="{{route('freecauses.storeOffer')}}" method="post" enctype="multipart/form-data" data-parsley-validate>
                                @csrf
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="reply_text">{{__('dashboard.cause_number')}}</label>
                                        <input type="text" class="form-control" readonly value="{{$cause->number}}">
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="price" value="مجانا"	disabled>
